...
<html>
    <head>
        ...
        <script>
            ...
            // 初期化
            function init() {
                Efw('testword_listcheck',{testno : testno});
            }
            ...
            function checkWord(obj){
                ...
                Efw('testword_checkword',{testno:testno, subno:subno, kbn:kbn, book:book, classification:classification, wordseq:wordseq, checkresult:checkresult});
            ...
            function playNextAudio(index) {
                ...
                if (index < audios.length) {
                    var currentAudio = audios[index];
                    
                    $("audio").eq(index).next().show();
                    // alert(currentAudio.next());
                    currentAudio.play();
                    currentAudio.onended = function() {

                        $("audio").eq(index).next().hide();
                        index++;
                        setTimeout(() => {
                            playNextAudio(index);
                        }, 2000);
    ...
    <body onload="init();">
        <div style="overflow: auto;">
            <div class="content">
                    ...
                    <table class="table_detail_header" style="table-layout: fixed;">
                        <thead>
                            <tr class="header">
                                ...
                                <th style="width: 580px;">正解</th>
                                <th style="width: 300px;">答え</th>
                ...
                <div class="c_detail_content" style="overflow: auto;height: 1000px;">
