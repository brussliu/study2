...
create table public."STY_単語テスト情報" (
  "テスト番号" character varying(20) not null
  , "書籍" character varying(50)
  , "分類" character varying(200)
  , "テスト方式" character varying(50)
  , "テスト種別" character varying(50)
  , "難易度" character varying(50)
  , "数量" integer
  , "開始時間" timestamp(6) with time zone
  , "終了時間" timestamp(6) with time zone
