    ...
    <head>
        ...
        <script>
            ...
            function readKeyCode(){
                ...
                $.ajax({
                    url: 'http://192.168.0.5:8080/study/efwRestAPI/keymonitor', // 替换为你的API URL
            ...
            function openNote(){
                ...
                window.open("testword_note.jsp?flg=3&div=1&pc=G", 'wordnote', windowFeatures);
