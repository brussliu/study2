...
<div class="dialog" id="testword_handwriting_inputdialog" style="display:block;background-color: rgb(255,255,240);overflow:hidden;">
    <script>
        var testword_handwriting_inputdialog = null;
        $(function () {
            testword_handwriting_inputdialog = $("#testword_handwriting_inputdialog").dialog({
                title: "単語手書き",
                autoOpen: false,
                resizable: true,
                height: 800,
