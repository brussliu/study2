<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <div class="dialog" id="testword_inputdialog" style="display:block;background-color: rgb(255,255,240);">
        <script>
            var testword_inputdialog = null;
            $(function () {
                testword_inputdialog = $("#testword_inputdialog").dialog({
                    title: "単語リスト",
                    autoOpen: false,
                    resizable: true,
                    height: 800,
