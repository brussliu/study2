var testword_listword = {};
testword_listword.name = "単語テスト開始";
testword_listword.paramsFormat = {

	testno : null,
};

testword_listword.fire = function (params) {
	...
	ret.eval("testword_inputdialog.dialog('open');");
	// 画面へ結果を返す
	return ret;
