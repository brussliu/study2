var testword_init_initclassification = {};
testword_init_initclassification.name = "単語テスト開始";
testword_init_initclassification.paramsFormat = {

	"#opt_book": null,
};

testword_init_initclassification.fire = function (params) {
